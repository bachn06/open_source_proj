            ...
            <ul className="sort-price">
              <li className="sort-price__item">
                <Input
                  ...
                  type="radio"
                  name="price"
                  onChange={() => history.push("/product?price[lt]=100000")}
              ...
              <li className="sort-price__item">
                <Input
                  ...
                  id="price-2"
                  onChange={() =>
                    history.push("?price[gte]=100000&price[lte]=200000")
                  }
                  checked={
              ...
              <li className="sort-price__item">
                <Input
                  ...
                  id="price-3"
                  onChange={() =>
                    history.push("?price[gte]=200000&price[lte]=300000")
                  }
                  checked={
              ...
              <li className="sort-price__item">
                <Input
                  ...
                  id="price-4"
                  onChange={() =>
                    history.push("?price[gte]=300000&price[lte]=500000")
                  }
                  checked={
              ...
              <li className="sort-price__item">
                <Input
                  ...
                  id="price-5"
                  onChange={() =>
                    history.push("?price[gte]=500000&price[lte]=1000000")
                  }
                  checked={
              ...
              <li className="sort-price__item">
                <Input
                  ...
                  name="price"
                  id="price-6"
                  onChange={() => history.push("?price[gt]=1000000")}
