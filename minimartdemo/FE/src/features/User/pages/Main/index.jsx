          ...
          <div className="user__nav">
            <div className="user__nav__header">
              ...
              <div className="user__nav__basic-info">
                ...
                <Link to="/user/profile" className="user__nav__sub-text">
            ...
            <ul className="user__nav__list">
              <li className="user__nav__item">
                <i className="fas fa-user"></i>
                <Link to="/user/profile" className="user__nav__link">
                  Tài khoản của tôi
                </Link>
                <ul
              ...
              <li className="user__nav__item">
                ...
                <NavLink exact to="/user/orders" className="user__nav__link">
                  Đơn hàng
                </NavLink>
              </li>
            </ul>
